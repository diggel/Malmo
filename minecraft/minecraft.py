...
from spockplugin import MicropsiPlugin
# from minecraft_graph_locomotion import MinecraftGraphLocomotion
# from minecraft_vision import MinecraftVision
# from minecraft_histogram_vision import MinecraftHistogramVision
...
class Minecraft(World):
    ...
    assets = {
        'template': 'resources/minecraft.tpl',
        'paperjs': 'resources/minecraft.js',
        'x': 256,
        'y': 256,
    }
...
class Minecraft2D(Minecraft):
    ...
    assets = {
        'template': 'resources/minecraft.tpl',
        'paperjs': 'resources/minecraft2d.js',
    }
