...
function loadWorldInfo() {
    ...
    $.getScript('/world_assets/Minecraft2D/resources/minecraft_struct.js', function () {
        for (var key in block_names) {
            var block_name = block_names[key];
            all_images = all_images + '<img id="mc_block_img_' + block_name + '" src="/world_assets/Minecraft2D/resources/block_textures/' + block_name + '.png">';
